...
/* The tokens above are white-alpha overlays tuned for dark themes — invisible on
   a light background. VS Code tags the webview body with vscode-light /
   vscode-high-contrast-light, so remap to dark-alpha overlays and higher-contrast
   accents there. Dark stays the default above. */
